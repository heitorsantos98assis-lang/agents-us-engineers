# 17-structured-cabling-ansi-tia-568 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `17-structured-cabling-ansi-tia-568.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 17-structured-cabling-ansi-tia-568.zip
```
...
cp 17-structured-cabling-ansi-tia-568.md .claude/agents/
...
```
Use the structured-cabling-ansi-tia-568 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 17-structured-cabling-ansi-tia-568.md
# OR
...
```bash
rm .claude/agents/17-structured-cabling-ansi-tia-568.md
# OR
rm ~/.claude/agents/17-structured-cabling-ansi-tia-568.md
```
