# 17-structured-cabling-ansi-tia-568 — Codex Agent
...
cp 17-structured-cabling-ansi-tia-568.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 17-structured-cabling-ansi-tia-568.md
# OR
...
```bash
rm .codex/agents/17-structured-cabling-ansi-tia-568.md
# OR
rm .codex/agents/17-structured-cabling-ansi-tia-568.md
```
