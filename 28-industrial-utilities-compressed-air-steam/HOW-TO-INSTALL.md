# 28-industrial-utilities-compressed-air-steam — Codex Agent
...
cp 28-industrial-utilities-compressed-air-steam.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 28-industrial-utilities-compressed-air-steam.md
# OR
...
```bash
rm .codex/agents/28-industrial-utilities-compressed-air-steam.md
# OR
rm .codex/agents/28-industrial-utilities-compressed-air-steam.md
```
