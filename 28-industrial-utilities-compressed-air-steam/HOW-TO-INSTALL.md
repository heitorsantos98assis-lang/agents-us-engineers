# 28-industrial-utilities-compressed-air-steam — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `28-industrial-utilities-compressed-air-steam.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 28-industrial-utilities-compressed-air-steam.zip
```
...
cp 28-industrial-utilities-compressed-air-steam.md .claude/agents/
...
```
Use the industrial-utilities-compressed-air-steam subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 28-industrial-utilities-compressed-air-steam.md
# OR
...
```bash
rm .claude/agents/28-industrial-utilities-compressed-air-steam.md
# OR
rm ~/.claude/agents/28-industrial-utilities-compressed-air-steam.md
```
