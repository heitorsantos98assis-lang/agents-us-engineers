# 05-shallow-foundation-design-spread-footing-mat — Codex Agent
...
cp 05-shallow-foundation-design-spread-footing-mat.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 05-shallow-foundation-design-spread-footing-mat.md
# OR
...
```bash
rm .codex/agents/05-shallow-foundation-design-spread-footing-mat.md
# OR
rm .codex/agents/05-shallow-foundation-design-spread-footing-mat.md
```
