# 05-shallow-foundation-design-spread-footing-mat — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `05-shallow-foundation-design-spread-footing-mat.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 05-shallow-foundation-design-spread-footing-mat.zip
```
...
cp 05-shallow-foundation-design-spread-footing-mat.md .claude/agents/
...
```
Use the shallow-foundation-design-spread-footing-mat subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 05-shallow-foundation-design-spread-footing-mat.md
# OR
...
```bash
rm .claude/agents/05-shallow-foundation-design-spread-footing-mat.md
# OR
rm ~/.claude/agents/05-shallow-foundation-design-spread-footing-mat.md
```
