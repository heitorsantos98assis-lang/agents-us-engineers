# 14-electrical-load-schedule-phase-balancing — Codex Agent
...
cp 14-electrical-load-schedule-phase-balancing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 14-electrical-load-schedule-phase-balancing.md
# OR
...
```bash
rm .codex/agents/14-electrical-load-schedule-phase-balancing.md
# OR
rm .codex/agents/14-electrical-load-schedule-phase-balancing.md
```
