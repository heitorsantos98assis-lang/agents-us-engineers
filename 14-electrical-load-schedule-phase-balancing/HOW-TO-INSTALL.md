# 14-electrical-load-schedule-phase-balancing — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `14-electrical-load-schedule-phase-balancing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 14-electrical-load-schedule-phase-balancing.zip
```
...
cp 14-electrical-load-schedule-phase-balancing.md .claude/agents/
...
```
Use the electrical-load-schedule-phase-balancing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 14-electrical-load-schedule-phase-balancing.md
# OR
...
```bash
rm .claude/agents/14-electrical-load-schedule-phase-balancing.md
# OR
rm ~/.claude/agents/14-electrical-load-schedule-phase-balancing.md
```
