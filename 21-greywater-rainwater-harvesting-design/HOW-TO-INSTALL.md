# 21-greywater-rainwater-harvesting-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `21-greywater-rainwater-harvesting-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 21-greywater-rainwater-harvesting-design.zip
```
...
cp 21-greywater-rainwater-harvesting-design.md .claude/agents/
...
```
Use the greywater-rainwater-harvesting-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 21-greywater-rainwater-harvesting-design.md
# OR
...
```bash
rm .claude/agents/21-greywater-rainwater-harvesting-design.md
# OR
rm ~/.claude/agents/21-greywater-rainwater-harvesting-design.md
```
