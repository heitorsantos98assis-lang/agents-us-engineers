# 48-occupational-safety-health-program-osha — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `48-occupational-safety-health-program-osha.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 48-occupational-safety-health-program-osha.zip
```
...
cp 48-occupational-safety-health-program-osha.md .claude/agents/
...
```
Use the occupational-safety-health-program-osha subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 48-occupational-safety-health-program-osha.md
# OR
...
```bash
rm .claude/agents/48-occupational-safety-health-program-osha.md
# OR
rm ~/.claude/agents/48-occupational-safety-health-program-osha.md
```
