# 48-occupational-safety-health-program-osha — Codex Agent
...
cp 48-occupational-safety-health-program-osha.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 48-occupational-safety-health-program-osha.md
# OR
...
```bash
rm .codex/agents/48-occupational-safety-health-program-osha.md
# OR
rm .codex/agents/48-occupational-safety-health-program-osha.md
```
