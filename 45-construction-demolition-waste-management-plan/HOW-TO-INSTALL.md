# 45-construction-demolition-waste-management-plan — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `45-construction-demolition-waste-management-plan.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 45-construction-demolition-waste-management-plan.zip
```
...
cp 45-construction-demolition-waste-management-plan.md .claude/agents/
...
```
Use the construction-demolition-waste-management-plan subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 45-construction-demolition-waste-management-plan.md
# OR
...
```bash
rm .claude/agents/45-construction-demolition-waste-management-plan.md
# OR
rm ~/.claude/agents/45-construction-demolition-waste-management-plan.md
```
