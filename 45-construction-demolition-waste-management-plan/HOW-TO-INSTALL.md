# 45-construction-demolition-waste-management-plan — Codex Agent
...
cp 45-construction-demolition-waste-management-plan.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 45-construction-demolition-waste-management-plan.md
# OR
...
```bash
rm .codex/agents/45-construction-demolition-waste-management-plan.md
# OR
rm .codex/agents/45-construction-demolition-waste-management-plan.md
```
