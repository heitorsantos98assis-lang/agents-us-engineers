# 13-utility-service-entrance-interconnection — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `13-utility-service-entrance-interconnection.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 13-utility-service-entrance-interconnection.zip
```
...
cp 13-utility-service-entrance-interconnection.md .claude/agents/
...
```
Use the utility-service-entrance-interconnection subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 13-utility-service-entrance-interconnection.md
# OR
...
```bash
rm .claude/agents/13-utility-service-entrance-interconnection.md
# OR
rm ~/.claude/agents/13-utility-service-entrance-interconnection.md
```
