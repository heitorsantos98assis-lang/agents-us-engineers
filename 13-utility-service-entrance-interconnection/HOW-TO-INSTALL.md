# 13-utility-service-entrance-interconnection — Codex Agent
...
cp 13-utility-service-entrance-interconnection.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 13-utility-service-entrance-interconnection.md
# OR
...
```bash
rm .codex/agents/13-utility-service-entrance-interconnection.md
# OR
rm .codex/agents/13-utility-service-entrance-interconnection.md
```
