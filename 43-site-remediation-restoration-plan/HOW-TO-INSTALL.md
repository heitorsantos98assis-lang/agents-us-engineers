# 43-site-remediation-restoration-plan — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `43-site-remediation-restoration-plan.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 43-site-remediation-restoration-plan.zip
```
...
cp 43-site-remediation-restoration-plan.md .claude/agents/
...
```
Use the site-remediation-restoration-plan subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 43-site-remediation-restoration-plan.md
# OR
...
```bash
rm .claude/agents/43-site-remediation-restoration-plan.md
# OR
rm ~/.claude/agents/43-site-remediation-restoration-plan.md
```
