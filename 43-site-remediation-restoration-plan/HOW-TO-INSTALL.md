# 43-site-remediation-restoration-plan — Codex Agent
...
cp 43-site-remediation-restoration-plan.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 43-site-remediation-restoration-plan.md
# OR
...
```bash
rm .codex/agents/43-site-remediation-restoration-plan.md
# OR
rm .codex/agents/43-site-remediation-restoration-plan.md
```
