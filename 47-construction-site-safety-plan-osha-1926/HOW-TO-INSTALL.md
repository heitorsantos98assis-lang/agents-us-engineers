# 47-construction-site-safety-plan-osha-1926 — Codex Agent
...
cp 47-construction-site-safety-plan-osha-1926.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 47-construction-site-safety-plan-osha-1926.md
# OR
...
```bash
rm .codex/agents/47-construction-site-safety-plan-osha-1926.md
# OR
rm .codex/agents/47-construction-site-safety-plan-osha-1926.md
```
