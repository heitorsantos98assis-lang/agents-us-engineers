# 47-construction-site-safety-plan-osha-1926 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `47-construction-site-safety-plan-osha-1926.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 47-construction-site-safety-plan-osha-1926.zip
```
...
cp 47-construction-site-safety-plan-osha-1926.md .claude/agents/
...
```
Use the construction-site-safety-plan-osha-1926 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 47-construction-site-safety-plan-osha-1926.md
# OR
...
```bash
rm .claude/agents/47-construction-site-safety-plan-osha-1926.md
# OR
rm ~/.claude/agents/47-construction-site-safety-plan-osha-1926.md
```
