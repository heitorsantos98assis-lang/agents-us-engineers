# 10-electrical-design-residential-nec — Codex Agent
...
cp 10-electrical-design-residential-nec.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 10-electrical-design-residential-nec.md
# OR
...
```bash
rm .codex/agents/10-electrical-design-residential-nec.md
# OR
rm .codex/agents/10-electrical-design-residential-nec.md
```
