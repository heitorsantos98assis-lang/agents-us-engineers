# 10-electrical-design-residential-nec — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `10-electrical-design-residential-nec.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 10-electrical-design-residential-nec.zip
```
...
cp 10-electrical-design-residential-nec.md .claude/agents/
...
```
Use the electrical-design-residential-nec subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 10-electrical-design-residential-nec.md
# OR
...
```bash
rm .claude/agents/10-electrical-design-residential-nec.md
# OR
rm ~/.claude/agents/10-electrical-design-residential-nec.md
```
