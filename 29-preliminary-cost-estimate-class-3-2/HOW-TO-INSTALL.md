# 29-preliminary-cost-estimate-class-3-2 — Codex Agent
...
cp 29-preliminary-cost-estimate-class-3-2.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 29-preliminary-cost-estimate-class-3-2.md
# OR
...
```bash
rm .codex/agents/29-preliminary-cost-estimate-class-3-2.md
# OR
rm .codex/agents/29-preliminary-cost-estimate-class-3-2.md
```
