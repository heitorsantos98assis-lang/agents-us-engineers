# 29-preliminary-cost-estimate-class-3-2 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `29-preliminary-cost-estimate-class-3-2.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 29-preliminary-cost-estimate-class-3-2.zip
```
...
cp 29-preliminary-cost-estimate-class-3-2.md .claude/agents/
...
```
Use the preliminary-cost-estimate-class-3-2 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 29-preliminary-cost-estimate-class-3-2.md
# OR
...
```bash
rm .claude/agents/29-preliminary-cost-estimate-class-3-2.md
# OR
rm ~/.claude/agents/29-preliminary-cost-estimate-class-3-2.md
```
