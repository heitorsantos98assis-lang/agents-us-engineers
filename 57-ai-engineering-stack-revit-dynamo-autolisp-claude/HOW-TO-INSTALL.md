# 57-ai-engineering-stack-revit-dynamo-autolisp-claude — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `57-ai-engineering-stack-revit-dynamo-autolisp-claude.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 57-ai-engineering-stack-revit-dynamo-autolisp-claude.zip
```
...
cp 57-ai-engineering-stack-revit-dynamo-autolisp-claude.md .claude/agents/
...
```
Use the ai-engineering-stack-revit-dynamo-autolisp-claude subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 57-ai-engineering-stack-revit-dynamo-autolisp-claude.md
# OR
...
```bash
rm .claude/agents/57-ai-engineering-stack-revit-dynamo-autolisp-claude.md
# OR
rm ~/.claude/agents/57-ai-engineering-stack-revit-dynamo-autolisp-claude.md
```
