# 08-post-tensioned-concrete-slab-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `08-post-tensioned-concrete-slab-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 08-post-tensioned-concrete-slab-design.zip
```
...
cp 08-post-tensioned-concrete-slab-design.md .claude/agents/
...
```
Use the post-tensioned-concrete-slab-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 08-post-tensioned-concrete-slab-design.md
# OR
...
```bash
rm .claude/agents/08-post-tensioned-concrete-slab-design.md
# OR
rm ~/.claude/agents/08-post-tensioned-concrete-slab-design.md
```
