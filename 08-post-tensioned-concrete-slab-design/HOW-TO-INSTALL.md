# 08-post-tensioned-concrete-slab-design — Codex Agent
...
cp 08-post-tensioned-concrete-slab-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 08-post-tensioned-concrete-slab-design.md
# OR
...
```bash
rm .codex/agents/08-post-tensioned-concrete-slab-design.md
# OR
rm .codex/agents/08-post-tensioned-concrete-slab-design.md
```
