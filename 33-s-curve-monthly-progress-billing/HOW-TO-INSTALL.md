# 33-s-curve-monthly-progress-billing — Codex Agent
...
cp 33-s-curve-monthly-progress-billing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 33-s-curve-monthly-progress-billing.md
# OR
...
```bash
rm .codex/agents/33-s-curve-monthly-progress-billing.md
# OR
rm .codex/agents/33-s-curve-monthly-progress-billing.md
```
