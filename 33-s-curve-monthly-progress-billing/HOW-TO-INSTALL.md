# 33-s-curve-monthly-progress-billing — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `33-s-curve-monthly-progress-billing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 33-s-curve-monthly-progress-billing.zip
```
...
cp 33-s-curve-monthly-progress-billing.md .claude/agents/
...
```
Use the s-curve-monthly-progress-billing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 33-s-curve-monthly-progress-billing.md
# OR
...
```bash
rm .claude/agents/33-s-curve-monthly-progress-billing.md
# OR
rm ~/.claude/agents/33-s-curve-monthly-progress-billing.md
```
