# 34-wbs-work-breakdown-structure — Codex Agent
...
cp 34-wbs-work-breakdown-structure.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 34-wbs-work-breakdown-structure.md
# OR
...
```bash
rm .codex/agents/34-wbs-work-breakdown-structure.md
# OR
rm .codex/agents/34-wbs-work-breakdown-structure.md
```
