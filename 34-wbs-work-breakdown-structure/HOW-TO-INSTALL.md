# 34-wbs-work-breakdown-structure — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `34-wbs-work-breakdown-structure.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 34-wbs-work-breakdown-structure.zip
```
...
cp 34-wbs-work-breakdown-structure.md .claude/agents/
...
```
Use the wbs-work-breakdown-structure subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 34-wbs-work-breakdown-structure.md
# OR
...
```bash
rm .claude/agents/34-wbs-work-breakdown-structure.md
# OR
rm ~/.claude/agents/34-wbs-work-breakdown-structure.md
```
