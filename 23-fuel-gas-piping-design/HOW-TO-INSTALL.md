# 23-fuel-gas-piping-design — Codex Agent
...
cp 23-fuel-gas-piping-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 23-fuel-gas-piping-design.md
# OR
...
```bash
rm .codex/agents/23-fuel-gas-piping-design.md
# OR
rm .codex/agents/23-fuel-gas-piping-design.md
```
