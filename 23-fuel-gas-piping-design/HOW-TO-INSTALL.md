# 23-fuel-gas-piping-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `23-fuel-gas-piping-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 23-fuel-gas-piping-design.zip
```
...
cp 23-fuel-gas-piping-design.md .claude/agents/
...
```
Use the fuel-gas-piping-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 23-fuel-gas-piping-design.md
# OR
...
```bash
rm .claude/agents/23-fuel-gas-piping-design.md
# OR
rm ~/.claude/agents/23-fuel-gas-piping-design.md
```
