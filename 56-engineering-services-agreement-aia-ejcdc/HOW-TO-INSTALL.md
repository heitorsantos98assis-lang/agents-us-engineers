...
cp 56-engineering-services-agreement-aia-ejcdc.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 56-engineering-services-agreement-aia-ejcdc.md
# OR
...
```bash
rm .claude/agents/56-engineering-services-agreement-aia-ejcdc.md
# OR
rm ~/.claude/agents/56-engineering-services-agreement-aia-ejcdc.md
```
