# 56-engineering-services-agreement-aia-ejcdc — Codex Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `56-engineering-services-agreement-aia-ejcdc.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 56-engineering-services-agreement-aia-ejcdc.zip
```
...
cp 56-engineering-services-agreement-aia-ejcdc.md .codex/agents/
...
```
Use the engineering-services-agreement-aia-ejcdc subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 56-engineering-services-agreement-aia-ejcdc.md
# OR
...
```bash
rm .codex/agents/56-engineering-services-agreement-aia-ejcdc.md
# OR
rm .codex/agents/56-engineering-services-agreement-aia-ejcdc.md
```
