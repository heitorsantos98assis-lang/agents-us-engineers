# 30-detailed-cost-estimate-csi-masterformat-rsmeans — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `30-detailed-cost-estimate-csi-masterformat-rsmeans.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 30-detailed-cost-estimate-csi-masterformat-rsmeans.zip
```
...
cp 30-detailed-cost-estimate-csi-masterformat-rsmeans.md .claude/agents/
...
```
Use the detailed-cost-estimate-csi-masterformat-rsmeans subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 30-detailed-cost-estimate-csi-masterformat-rsmeans.md
# OR
...
```bash
rm .claude/agents/30-detailed-cost-estimate-csi-masterformat-rsmeans.md
# OR
rm ~/.claude/agents/30-detailed-cost-estimate-csi-masterformat-rsmeans.md
```
