# 30-detailed-cost-estimate-csi-masterformat-rsmeans — Codex Agent
...
cp 30-detailed-cost-estimate-csi-masterformat-rsmeans.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 30-detailed-cost-estimate-csi-masterformat-rsmeans.md
# OR
...
```bash
rm .codex/agents/30-detailed-cost-estimate-csi-masterformat-rsmeans.md
# OR
rm .codex/agents/30-detailed-cost-estimate-csi-masterformat-rsmeans.md
```
