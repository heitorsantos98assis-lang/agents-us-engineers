# 15-solar-pv-grid-interactive-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `15-solar-pv-grid-interactive-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 15-solar-pv-grid-interactive-design.zip
```
...
cp 15-solar-pv-grid-interactive-design.md .claude/agents/
...
```
Use the solar-pv-grid-interactive-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 15-solar-pv-grid-interactive-design.md
# OR
...
```bash
rm .claude/agents/15-solar-pv-grid-interactive-design.md
# OR
rm ~/.claude/agents/15-solar-pv-grid-interactive-design.md
```
