# 15-solar-pv-grid-interactive-design — Codex Agent
...
cp 15-solar-pv-grid-interactive-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 15-solar-pv-grid-interactive-design.md
# OR
...
```bash
rm .codex/agents/15-solar-pv-grid-interactive-design.md
# OR
rm .codex/agents/15-solar-pv-grid-interactive-design.md
```
