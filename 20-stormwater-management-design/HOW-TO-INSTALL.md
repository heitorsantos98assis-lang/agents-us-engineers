# 20-stormwater-management-design — Codex Agent
...
cp 20-stormwater-management-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 20-stormwater-management-design.md
# OR
...
```bash
rm .codex/agents/20-stormwater-management-design.md
# OR
rm .codex/agents/20-stormwater-management-design.md
```
