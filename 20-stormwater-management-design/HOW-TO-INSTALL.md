# 20-stormwater-management-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `20-stormwater-management-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 20-stormwater-management-design.zip
```
...
cp 20-stormwater-management-design.md .claude/agents/
...
```
Use the stormwater-management-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 20-stormwater-management-design.md
# OR
...
```bash
rm .claude/agents/20-stormwater-management-design.md
# OR
rm ~/.claude/agents/20-stormwater-management-design.md
```
