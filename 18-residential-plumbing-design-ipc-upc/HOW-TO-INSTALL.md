# 18-residential-plumbing-design-ipc-upc — Codex Agent
...
cp 18-residential-plumbing-design-ipc-upc.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 18-residential-plumbing-design-ipc-upc.md
# OR
...
```bash
rm .codex/agents/18-residential-plumbing-design-ipc-upc.md
# OR
rm .codex/agents/18-residential-plumbing-design-ipc-upc.md
```
