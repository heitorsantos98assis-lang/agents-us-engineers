# 18-residential-plumbing-design-ipc-upc — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `18-residential-plumbing-design-ipc-upc.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 18-residential-plumbing-design-ipc-upc.zip
```
...
cp 18-residential-plumbing-design-ipc-upc.md .claude/agents/
...
```
Use the residential-plumbing-design-ipc-upc subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 18-residential-plumbing-design-ipc-upc.md
# OR
...
```bash
rm .claude/agents/18-residential-plumbing-design-ipc-upc.md
# OR
rm ~/.claude/agents/18-residential-plumbing-design-ipc-upc.md
```
