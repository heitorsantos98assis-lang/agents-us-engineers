# 01-reinforced-concrete-design-aci-318 — Claude Code Agent
...
cp 01-reinforced-concrete-design-aci-318.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 01-reinforced-concrete-design-aci-318.md
# OR
...
```bash
rm .claude/agents/01-reinforced-concrete-design-aci-318.md
# OR
rm ~/.claude/agents/01-reinforced-concrete-design-aci-318.md
```
