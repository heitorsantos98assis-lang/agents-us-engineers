# 39-drone-photogrammetry-uav-mapping — Codex Agent
...
cp 39-drone-photogrammetry-uav-mapping.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 39-drone-photogrammetry-uav-mapping.md
# OR
...
```bash
rm .codex/agents/39-drone-photogrammetry-uav-mapping.md
# OR
rm .codex/agents/39-drone-photogrammetry-uav-mapping.md
```
