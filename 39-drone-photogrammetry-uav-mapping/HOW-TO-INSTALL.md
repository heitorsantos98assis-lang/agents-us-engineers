# 39-drone-photogrammetry-uav-mapping — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `39-drone-photogrammetry-uav-mapping.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 39-drone-photogrammetry-uav-mapping.zip
```
...
cp 39-drone-photogrammetry-uav-mapping.md .claude/agents/
...
```
Use the drone-photogrammetry-uav-mapping subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 39-drone-photogrammetry-uav-mapping.md
# OR
...
```bash
rm .claude/agents/39-drone-photogrammetry-uav-mapping.md
# OR
rm ~/.claude/agents/39-drone-photogrammetry-uav-mapping.md
```
