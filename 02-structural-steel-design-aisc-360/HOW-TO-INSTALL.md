...
cp 02-structural-steel-design-aisc-360.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 02-structural-steel-design-aisc-360.md
# OR
...
```bash
rm .claude/agents/02-structural-steel-design-aisc-360.md
# OR
rm ~/.claude/agents/02-structural-steel-design-aisc-360.md
```
