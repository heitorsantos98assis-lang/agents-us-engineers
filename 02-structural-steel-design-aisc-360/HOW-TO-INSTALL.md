# 02-structural-steel-design-aisc-360 — Codex Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `02-structural-steel-design-aisc-360.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 02-structural-steel-design-aisc-360.zip
```
...
cp 02-structural-steel-design-aisc-360.md .codex/agents/
...
```
Use the structural-steel-design-aisc-360 subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 02-structural-steel-design-aisc-360.md
# OR
...
```bash
rm .codex/agents/02-structural-steel-design-aisc-360.md
# OR
rm .codex/agents/02-structural-steel-design-aisc-360.md
```
