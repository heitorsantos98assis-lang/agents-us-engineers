# 46-environmental-impact-statement-nepa-state — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `46-environmental-impact-statement-nepa-state.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 46-environmental-impact-statement-nepa-state.zip
```
...
cp 46-environmental-impact-statement-nepa-state.md .claude/agents/
...
```
Use the environmental-impact-statement-nepa-state subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 46-environmental-impact-statement-nepa-state.md
# OR
...
```bash
rm .claude/agents/46-environmental-impact-statement-nepa-state.md
# OR
rm ~/.claude/agents/46-environmental-impact-statement-nepa-state.md
```
