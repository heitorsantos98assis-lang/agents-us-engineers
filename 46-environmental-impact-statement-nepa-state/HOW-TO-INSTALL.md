# 46-environmental-impact-statement-nepa-state — Codex Agent
...
cp 46-environmental-impact-statement-nepa-state.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 46-environmental-impact-statement-nepa-state.md
# OR
...
```bash
rm .codex/agents/46-environmental-impact-statement-nepa-state.md
# OR
rm .codex/agents/46-environmental-impact-statement-nepa-state.md
```
