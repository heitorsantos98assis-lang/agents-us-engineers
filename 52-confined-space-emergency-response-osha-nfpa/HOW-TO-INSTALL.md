# 52-confined-space-emergency-response-osha-nfpa — Codex Agent
...
cp 52-confined-space-emergency-response-osha-nfpa.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 52-confined-space-emergency-response-osha-nfpa.md
# OR
...
```bash
rm .codex/agents/52-confined-space-emergency-response-osha-nfpa.md
# OR
rm .codex/agents/52-confined-space-emergency-response-osha-nfpa.md
```
