# 52-confined-space-emergency-response-osha-nfpa — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `52-confined-space-emergency-response-osha-nfpa.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 52-confined-space-emergency-response-osha-nfpa.zip
```
...
cp 52-confined-space-emergency-response-osha-nfpa.md .claude/agents/
...
```
Use the confined-space-emergency-response-osha-nfpa subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 52-confined-space-emergency-response-osha-nfpa.md
# OR
...
```bash
rm .claude/agents/52-confined-space-emergency-response-osha-nfpa.md
# OR
rm ~/.claude/agents/52-confined-space-emergency-response-osha-nfpa.md
```
