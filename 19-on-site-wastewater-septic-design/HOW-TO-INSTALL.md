# 19-on-site-wastewater-septic-design — Codex Agent
...
cp 19-on-site-wastewater-septic-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 19-on-site-wastewater-septic-design.md
# OR
...
```bash
rm .codex/agents/19-on-site-wastewater-septic-design.md
# OR
rm .codex/agents/19-on-site-wastewater-septic-design.md
```
