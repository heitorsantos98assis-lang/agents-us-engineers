# 19-on-site-wastewater-septic-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `19-on-site-wastewater-septic-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 19-on-site-wastewater-septic-design.zip
```
...
cp 19-on-site-wastewater-septic-design.md .claude/agents/
...
```
Use the on-site-wastewater-septic-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 19-on-site-wastewater-septic-design.md
# OR
...
```bash
rm .claude/agents/19-on-site-wastewater-septic-design.md
# OR
rm ~/.claude/agents/19-on-site-wastewater-septic-design.md
```
