...
cp 54-forensic-engineering-expert-witness.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 54-forensic-engineering-expert-witness.md
# OR
...
```bash
rm .claude/agents/54-forensic-engineering-expert-witness.md
# OR
rm ~/.claude/agents/54-forensic-engineering-expert-witness.md
```
