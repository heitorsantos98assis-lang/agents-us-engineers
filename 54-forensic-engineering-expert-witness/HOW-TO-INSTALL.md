# 54-forensic-engineering-expert-witness — Codex Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `54-forensic-engineering-expert-witness.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 54-forensic-engineering-expert-witness.zip
```
...
cp 54-forensic-engineering-expert-witness.md .codex/agents/
...
```
Use the forensic-engineering-expert-witness subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 54-forensic-engineering-expert-witness.md
# OR
...
```bash
rm .codex/agents/54-forensic-engineering-expert-witness.md
# OR
rm .codex/agents/54-forensic-engineering-expert-witness.md
```
