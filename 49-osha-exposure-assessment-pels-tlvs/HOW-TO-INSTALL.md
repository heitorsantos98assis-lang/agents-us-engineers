# 49-osha-exposure-assessment-pels-tlvs — Codex Agent
...
cp 49-osha-exposure-assessment-pels-tlvs.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 49-osha-exposure-assessment-pels-tlvs.md
# OR
...
```bash
rm .codex/agents/49-osha-exposure-assessment-pels-tlvs.md
# OR
rm .codex/agents/49-osha-exposure-assessment-pels-tlvs.md
```
