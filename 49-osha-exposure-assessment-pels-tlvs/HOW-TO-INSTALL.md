# 49-osha-exposure-assessment-pels-tlvs — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `49-osha-exposure-assessment-pels-tlvs.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 49-osha-exposure-assessment-pels-tlvs.zip
```
...
cp 49-osha-exposure-assessment-pels-tlvs.md .claude/agents/
...
```
Use the osha-exposure-assessment-pels-tlvs subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 49-osha-exposure-assessment-pels-tlvs.md
# OR
...
```bash
rm .claude/agents/49-osha-exposure-assessment-pels-tlvs.md
# OR
rm ~/.claude/agents/49-osha-exposure-assessment-pels-tlvs.md
```
