# 55-pre-construction-condition-survey-neighbor — Codex Agent
...
cp 55-pre-construction-condition-survey-neighbor.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 55-pre-construction-condition-survey-neighbor.md
# OR
...
```bash
rm .codex/agents/55-pre-construction-condition-survey-neighbor.md
# OR
rm .codex/agents/55-pre-construction-condition-survey-neighbor.md
```
