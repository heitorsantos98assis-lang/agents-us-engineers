# 11-electrical-design-commercial-industrial-medium-voltage — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `11-electrical-design-commercial-industrial-medium-voltage.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 11-electrical-design-commercial-industrial-medium-voltage.zip
```
...
cp 11-electrical-design-commercial-industrial-medium-voltage.md .claude/agents/
...
```
Use the electrical-design-commercial-industrial-medium-voltage subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 11-electrical-design-commercial-industrial-medium-voltage.md
# OR
...
```bash
rm .claude/agents/11-electrical-design-commercial-industrial-medium-voltage.md
# OR
rm ~/.claude/agents/11-electrical-design-commercial-industrial-medium-voltage.md
```
