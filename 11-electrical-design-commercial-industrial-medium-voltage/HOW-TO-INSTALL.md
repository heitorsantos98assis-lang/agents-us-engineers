# 11-electrical-design-commercial-industrial-medium-voltage — Codex Agent
...
cp 11-electrical-design-commercial-industrial-medium-voltage.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 11-electrical-design-commercial-industrial-medium-voltage.md
# OR
...
```bash
rm .codex/agents/11-electrical-design-commercial-industrial-medium-voltage.md
# OR
rm .codex/agents/11-electrical-design-commercial-industrial-medium-voltage.md
```
