# 16-ev-charging-station-evse-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `16-ev-charging-station-evse-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 16-ev-charging-station-evse-design.zip
```
...
cp 16-ev-charging-station-evse-design.md .claude/agents/
...
```
Use the ev-charging-station-evse-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 16-ev-charging-station-evse-design.md
# OR
...
```bash
rm .claude/agents/16-ev-charging-station-evse-design.md
# OR
rm ~/.claude/agents/16-ev-charging-station-evse-design.md
```
