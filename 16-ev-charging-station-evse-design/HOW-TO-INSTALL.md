# 16-ev-charging-station-evse-design — Codex Agent
...
cp 16-ev-charging-station-evse-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 16-ev-charging-station-evse-design.md
# OR
...
```bash
rm .codex/agents/16-ev-charging-station-evse-design.md
# OR
rm .codex/agents/16-ev-charging-station-evse-design.md
```
