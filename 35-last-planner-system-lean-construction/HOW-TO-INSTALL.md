# 35-last-planner-system-lean-construction — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `35-last-planner-system-lean-construction.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 35-last-planner-system-lean-construction.zip
```
...
cp 35-last-planner-system-lean-construction.md .claude/agents/
...
```
Use the last-planner-system-lean-construction subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 35-last-planner-system-lean-construction.md
# OR
...
```bash
rm .claude/agents/35-last-planner-system-lean-construction.md
# OR
rm ~/.claude/agents/35-last-planner-system-lean-construction.md
```
