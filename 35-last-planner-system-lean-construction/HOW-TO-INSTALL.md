# 35-last-planner-system-lean-construction — Codex Agent
...
cp 35-last-planner-system-lean-construction.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 35-last-planner-system-lean-construction.md
# OR
...
```bash
rm .codex/agents/35-last-planner-system-lean-construction.md
# OR
rm .codex/agents/35-last-planner-system-lean-construction.md
```
