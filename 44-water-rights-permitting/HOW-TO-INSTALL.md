# 44-water-rights-permitting — Codex Agent
...
cp 44-water-rights-permitting.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 44-water-rights-permitting.md
# OR
...
```bash
rm .codex/agents/44-water-rights-permitting.md
# OR
rm .codex/agents/44-water-rights-permitting.md
```
