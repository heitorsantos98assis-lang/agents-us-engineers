# 44-water-rights-permitting — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `44-water-rights-permitting.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 44-water-rights-permitting.zip
```
...
cp 44-water-rights-permitting.md .claude/agents/
...
```
Use the water-rights-permitting subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 44-water-rights-permitting.md
# OR
...
```bash
rm .claude/agents/44-water-rights-permitting.md
# OR
rm ~/.claude/agents/44-water-rights-permitting.md
```
