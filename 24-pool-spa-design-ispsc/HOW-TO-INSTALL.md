# 24-pool-spa-design-ispsc — Codex Agent
...
cp 24-pool-spa-design-ispsc.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 24-pool-spa-design-ispsc.md
# OR
...
```bash
rm .codex/agents/24-pool-spa-design-ispsc.md
# OR
rm .codex/agents/24-pool-spa-design-ispsc.md
```
