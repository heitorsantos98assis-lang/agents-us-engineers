# 27-commercial-kitchen-ventilation-design — Codex Agent
...
cp 27-commercial-kitchen-ventilation-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 27-commercial-kitchen-ventilation-design.md
# OR
...
```bash
rm .codex/agents/27-commercial-kitchen-ventilation-design.md
# OR
rm .codex/agents/27-commercial-kitchen-ventilation-design.md
```
