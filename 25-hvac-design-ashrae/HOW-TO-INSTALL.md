# 25-hvac-design-ashrae — Claude Code Agent
...
cp 25-hvac-design-ashrae.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 25-hvac-design-ashrae.md
# OR
...
```bash
rm .claude/agents/25-hvac-design-ashrae.md
# OR
rm ~/.claude/agents/25-hvac-design-ashrae.md
```
