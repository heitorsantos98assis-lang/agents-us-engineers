# 22-fire-protection-sprinkler-standpipe-design — Codex Agent
...
cp 22-fire-protection-sprinkler-standpipe-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 22-fire-protection-sprinkler-standpipe-design.md
# OR
...
```bash
rm .codex/agents/22-fire-protection-sprinkler-standpipe-design.md
# OR
rm .codex/agents/22-fire-protection-sprinkler-standpipe-design.md
```
