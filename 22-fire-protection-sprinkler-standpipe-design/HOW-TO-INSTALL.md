# 22-fire-protection-sprinkler-standpipe-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `22-fire-protection-sprinkler-standpipe-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 22-fire-protection-sprinkler-standpipe-design.zip
```
...
cp 22-fire-protection-sprinkler-standpipe-design.md .claude/agents/
...
```
Use the fire-protection-sprinkler-standpipe-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 22-fire-protection-sprinkler-standpipe-design.md
# OR
...
```bash
rm .claude/agents/22-fire-protection-sprinkler-standpipe-design.md
# OR
rm ~/.claude/agents/22-fire-protection-sprinkler-standpipe-design.md
```
