# 06-deep-foundation-design-piles-drilled-shaft — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `06-deep-foundation-design-piles-drilled-shaft.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 06-deep-foundation-design-piles-drilled-shaft.zip
```
...
cp 06-deep-foundation-design-piles-drilled-shaft.md .claude/agents/
...
```
Use the deep-foundation-design-piles-drilled-shaft subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 06-deep-foundation-design-piles-drilled-shaft.md
# OR
...
```bash
rm .claude/agents/06-deep-foundation-design-piles-drilled-shaft.md
# OR
rm ~/.claude/agents/06-deep-foundation-design-piles-drilled-shaft.md
```
