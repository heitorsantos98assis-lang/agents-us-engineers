# 06-deep-foundation-design-piles-drilled-shaft — Codex Agent
...
cp 06-deep-foundation-design-piles-drilled-shaft.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 06-deep-foundation-design-piles-drilled-shaft.md
# OR
...
```bash
rm .codex/agents/06-deep-foundation-design-piles-drilled-shaft.md
# OR
rm .codex/agents/06-deep-foundation-design-piles-drilled-shaft.md
```
