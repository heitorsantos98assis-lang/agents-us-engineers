# 09-structural-condition-assessment-existing-buildings — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `09-structural-condition-assessment-existing-buildings.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 09-structural-condition-assessment-existing-buildings.zip
```
...
cp 09-structural-condition-assessment-existing-buildings.md .claude/agents/
...
```
Use the structural-condition-assessment-existing-buildings subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 09-structural-condition-assessment-existing-buildings.md
# OR
...
```bash
rm .claude/agents/09-structural-condition-assessment-existing-buildings.md
# OR
rm ~/.claude/agents/09-structural-condition-assessment-existing-buildings.md
```
