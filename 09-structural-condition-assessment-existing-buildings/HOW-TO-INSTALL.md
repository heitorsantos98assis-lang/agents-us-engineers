# 09-structural-condition-assessment-existing-buildings — Codex Agent
...
cp 09-structural-condition-assessment-existing-buildings.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 09-structural-condition-assessment-existing-buildings.md
# OR
...
```bash
rm .codex/agents/09-structural-condition-assessment-existing-buildings.md
# OR
rm .codex/agents/09-structural-condition-assessment-existing-buildings.md
```
