# 26-mechanical-ventilation-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `26-mechanical-ventilation-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 26-mechanical-ventilation-design.zip
```
...
cp 26-mechanical-ventilation-design.md .claude/agents/
...
```
Use the mechanical-ventilation-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 26-mechanical-ventilation-design.md
# OR
...
```bash
rm .claude/agents/26-mechanical-ventilation-design.md
# OR
rm ~/.claude/agents/26-mechanical-ventilation-design.md
```
