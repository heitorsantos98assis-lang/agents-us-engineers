# 26-mechanical-ventilation-design — Codex Agent
...
cp 26-mechanical-ventilation-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 26-mechanical-ventilation-design.md
# OR
...
```bash
rm .codex/agents/26-mechanical-ventilation-design.md
# OR
rm .codex/agents/26-mechanical-ventilation-design.md
```
