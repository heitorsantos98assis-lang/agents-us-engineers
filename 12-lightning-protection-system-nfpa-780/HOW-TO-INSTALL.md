# 12-lightning-protection-system-nfpa-780 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `12-lightning-protection-system-nfpa-780.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 12-lightning-protection-system-nfpa-780.zip
```
...
cp 12-lightning-protection-system-nfpa-780.md .claude/agents/
...
```
Use the lightning-protection-system-nfpa-780 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 12-lightning-protection-system-nfpa-780.md
# OR
...
```bash
rm .claude/agents/12-lightning-protection-system-nfpa-780.md
# OR
rm ~/.claude/agents/12-lightning-protection-system-nfpa-780.md
```
