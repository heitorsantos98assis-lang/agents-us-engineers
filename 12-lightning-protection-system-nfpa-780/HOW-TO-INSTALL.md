# 12-lightning-protection-system-nfpa-780 — Codex Agent
...
cp 12-lightning-protection-system-nfpa-780.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 12-lightning-protection-system-nfpa-780.md
# OR
...
```bash
rm .codex/agents/12-lightning-protection-system-nfpa-780.md
# OR
rm .codex/agents/12-lightning-protection-system-nfpa-780.md
```
