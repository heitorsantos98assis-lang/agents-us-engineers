# 42-environmental-permitting-nepa-cwa-state — Codex Agent
...
cp 42-environmental-permitting-nepa-cwa-state.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 42-environmental-permitting-nepa-cwa-state.md
# OR
...
```bash
rm .codex/agents/42-environmental-permitting-nepa-cwa-state.md
# OR
rm .codex/agents/42-environmental-permitting-nepa-cwa-state.md
```
