# 42-environmental-permitting-nepa-cwa-state — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `42-environmental-permitting-nepa-cwa-state.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 42-environmental-permitting-nepa-cwa-state.zip
```
...
cp 42-environmental-permitting-nepa-cwa-state.md .claude/agents/
...
```
Use the environmental-permitting-nepa-cwa-state subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 42-environmental-permitting-nepa-cwa-state.md
# OR
...
```bash
rm .claude/agents/42-environmental-permitting-nepa-cwa-state.md
# OR
rm ~/.claude/agents/42-environmental-permitting-nepa-cwa-state.md
```
