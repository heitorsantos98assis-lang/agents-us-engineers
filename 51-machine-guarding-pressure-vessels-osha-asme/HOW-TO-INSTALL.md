# 51-machine-guarding-pressure-vessels-osha-asme — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `51-machine-guarding-pressure-vessels-osha-asme.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 51-machine-guarding-pressure-vessels-osha-asme.zip
```
...
cp 51-machine-guarding-pressure-vessels-osha-asme.md .claude/agents/
...
```
Use the machine-guarding-pressure-vessels-osha-asme subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 51-machine-guarding-pressure-vessels-osha-asme.md
# OR
...
```bash
rm .claude/agents/51-machine-guarding-pressure-vessels-osha-asme.md
# OR
rm ~/.claude/agents/51-machine-guarding-pressure-vessels-osha-asme.md
```
