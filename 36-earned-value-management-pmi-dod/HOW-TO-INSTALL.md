# 36-earned-value-management-pmi-dod — Codex Agent
...
cp 36-earned-value-management-pmi-dod.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 36-earned-value-management-pmi-dod.md
# OR
...
```bash
rm .codex/agents/36-earned-value-management-pmi-dod.md
# OR
rm .codex/agents/36-earned-value-management-pmi-dod.md
```
