# 36-earned-value-management-pmi-dod — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `36-earned-value-management-pmi-dod.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 36-earned-value-management-pmi-dod.zip
```
...
cp 36-earned-value-management-pmi-dod.md .claude/agents/
...
```
Use the earned-value-management-pmi-dod subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 36-earned-value-management-pmi-dod.md
# OR
...
```bash
rm .claude/agents/36-earned-value-management-pmi-dod.md
# OR
rm ~/.claude/agents/36-earned-value-management-pmi-dod.md
```
