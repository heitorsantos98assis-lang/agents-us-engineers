# 38-spt-soil-boring-investigation-astm-d1586 — Codex Agent
...
cp 38-spt-soil-boring-investigation-astm-d1586.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 38-spt-soil-boring-investigation-astm-d1586.md
# OR
...
```bash
rm .codex/agents/38-spt-soil-boring-investigation-astm-d1586.md
# OR
rm .codex/agents/38-spt-soil-boring-investigation-astm-d1586.md
```
