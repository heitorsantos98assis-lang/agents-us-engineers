# 38-spt-soil-boring-investigation-astm-d1586 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `38-spt-soil-boring-investigation-astm-d1586.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 38-spt-soil-boring-investigation-astm-d1586.zip
```
...
cp 38-spt-soil-boring-investigation-astm-d1586.md .claude/agents/
...
```
Use the spt-soil-boring-investigation-astm-d1586 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 38-spt-soil-boring-investigation-astm-d1586.md
# OR
...
```bash
rm .claude/agents/38-spt-soil-boring-investigation-astm-d1586.md
# OR
rm ~/.claude/agents/38-spt-soil-boring-investigation-astm-d1586.md
```
