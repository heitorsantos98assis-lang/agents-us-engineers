# 04-masonry-design-tms-402 — Codex Agent
...
cp 04-masonry-design-tms-402.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 04-masonry-design-tms-402.md
# OR
...
```bash
rm .codex/agents/04-masonry-design-tms-402.md
# OR
rm .codex/agents/04-masonry-design-tms-402.md
```
