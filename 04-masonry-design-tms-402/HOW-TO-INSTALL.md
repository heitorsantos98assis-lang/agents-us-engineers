# 04-masonry-design-tms-402 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `04-masonry-design-tms-402.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 04-masonry-design-tms-402.zip
```
...
cp 04-masonry-design-tms-402.md .claude/agents/
...
```
Use the masonry-design-tms-402 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 04-masonry-design-tms-402.md
# OR
...
```bash
rm .claude/agents/04-masonry-design-tms-402.md
# OR
rm ~/.claude/agents/04-masonry-design-tms-402.md
```
