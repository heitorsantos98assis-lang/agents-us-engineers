# 32-project-schedule-cpm-ms-project-p6 — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `32-project-schedule-cpm-ms-project-p6.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 32-project-schedule-cpm-ms-project-p6.zip
```
...
cp 32-project-schedule-cpm-ms-project-p6.md .claude/agents/
...
```
Use the project-schedule-cpm-ms-project-p6 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 32-project-schedule-cpm-ms-project-p6.md
# OR
...
```bash
rm .claude/agents/32-project-schedule-cpm-ms-project-p6.md
# OR
rm ~/.claude/agents/32-project-schedule-cpm-ms-project-p6.md
```
