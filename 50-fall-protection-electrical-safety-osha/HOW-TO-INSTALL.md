# 50-fall-protection-electrical-safety-osha — Codex Agent
...
cp 50-fall-protection-electrical-safety-osha.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 50-fall-protection-electrical-safety-osha.md
# OR
...
```bash
rm .codex/agents/50-fall-protection-electrical-safety-osha.md
# OR
rm .codex/agents/50-fall-protection-electrical-safety-osha.md
```
