# 50-fall-protection-electrical-safety-osha — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `50-fall-protection-electrical-safety-osha.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 50-fall-protection-electrical-safety-osha.zip
```
...
cp 50-fall-protection-electrical-safety-osha.md .claude/agents/
...
```
Use the fall-protection-electrical-safety-osha subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 50-fall-protection-electrical-safety-osha.md
# OR
...
```bash
rm .claude/agents/50-fall-protection-electrical-safety-osha.md
# OR
rm ~/.claude/agents/50-fall-protection-electrical-safety-osha.md
```
