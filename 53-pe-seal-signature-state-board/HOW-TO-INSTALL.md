# 53-pe-seal-signature-state-board — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `53-pe-seal-signature-state-board.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 53-pe-seal-signature-state-board.zip
```
...
cp 53-pe-seal-signature-state-board.md .claude/agents/
...
```
Use the pe-seal-signature-state-board subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 53-pe-seal-signature-state-board.md
# OR
...
```bash
rm .claude/agents/53-pe-seal-signature-state-board.md
# OR
rm ~/.claude/agents/53-pe-seal-signature-state-board.md
```
