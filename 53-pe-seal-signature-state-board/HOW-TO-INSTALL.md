# 53-pe-seal-signature-state-board — Codex Agent
...
cp 53-pe-seal-signature-state-board.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 53-pe-seal-signature-state-board.md
# OR
...
```bash
rm .codex/agents/53-pe-seal-signature-state-board.md
# OR
rm .codex/agents/53-pe-seal-signature-state-board.md
```
