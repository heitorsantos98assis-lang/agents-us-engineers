# 40-parcel-mapping-cadastral-survey — Codex Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (HL).

## What this agent does

See `40-parcel-mapping-cadastral-survey.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 40-parcel-mapping-cadastral-survey.zip
```
...
cp 40-parcel-mapping-cadastral-survey.md .codex/agents/
...
```
Use the parcel-mapping-cadastral-survey subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 40-parcel-mapping-cadastral-survey.md
# OR
...
```bash
rm .codex/agents/40-parcel-mapping-cadastral-survey.md
# OR
rm .codex/agents/40-parcel-mapping-cadastral-survey.md
```
