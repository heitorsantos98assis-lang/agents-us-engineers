...
cp 40-parcel-mapping-cadastral-survey.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 40-parcel-mapping-cadastral-survey.md
# OR
...
```bash
rm .claude/agents/40-parcel-mapping-cadastral-survey.md
# OR
rm ~/.claude/agents/40-parcel-mapping-cadastral-survey.md
```
