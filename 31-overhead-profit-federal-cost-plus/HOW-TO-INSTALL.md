# 31-overhead-profit-federal-cost-plus — Claude Code Agent

A specialist subagent from the **57 Agents for US Engineers** bundle (Bravy / ASV Digital).

## What this agent does

See `31-overhead-profit-federal-cost-plus.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 31-overhead-profit-federal-cost-plus.zip
```
...
cp 31-overhead-profit-federal-cost-plus.md .claude/agents/
...
```
Use the overhead-profit-federal-cost-plus subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 31-overhead-profit-federal-cost-plus.md
# OR
...
```bash
rm .claude/agents/31-overhead-profit-federal-cost-plus.md
# OR
rm ~/.claude/agents/31-overhead-profit-federal-cost-plus.md
```
