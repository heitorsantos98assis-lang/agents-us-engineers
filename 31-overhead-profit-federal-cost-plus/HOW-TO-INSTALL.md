# 31-overhead-profit-federal-cost-plus — Codex Agent
...
cp 31-overhead-profit-federal-cost-plus.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 31-overhead-profit-federal-cost-plus.md
# OR
...
```bash
rm .codex/agents/31-overhead-profit-federal-cost-plus.md
# OR
rm .codex/agents/31-overhead-profit-federal-cost-plus.md
```
